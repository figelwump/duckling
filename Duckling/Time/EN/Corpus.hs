...
allExamples = concat
 ...
 , examples (datetimeHoliday (2012, 4, 08, 0, 0, 0) Day "Easter Sunday")
  ...
  , examples (datetimeInterval ((2013, 2, 9, 0, 0, 0), (2013, 2, 10, 0, 0, 0)) Day)
             [ "this past weekend"
             ]
  ...
  , examples (datetimeInterval ((2013, 2, 16, 0, 0, 0), (2013, 2, 17, 0, 0, 0)) Day)
             [ "this week-end"
             ]
  ...
  , examples (datetimeInterval ((2013, 10, 26, 0, 0, 0), (2013, 10, 27, 0, 0, 0)) Day)
  ...
  , examples (datetimeInterval ((2013, 7, 27, 0, 0, 0), (2013, 7, 28, 0, 0, 0)) Day)
             [ "last wkend of July"
             ]
  , examples (datetimeInterval ((2017, 10, 28, 0, 0, 0), (2017, 10, 29, 0, 0, 0)) Day)
