...
allExamples = concat
  ...
  , examples (datetimeIntervalHoliday ((2013, 5, 25, 0, 0, 0), (2013, 5, 27, 0, 0, 0)) Day "Memorial Day weekend")
  ...
  , examples (datetimeIntervalHoliday ((2013, 8, 31, 0, 0, 0), (2013, 9, 2, 0, 0, 0)) Day "Labor Day weekend")
             [ "labor day weekend"
             ]
